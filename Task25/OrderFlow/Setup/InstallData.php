...
namespace Tychons\OrderFlow\Setup;
...
class InstallData implements InstallDataInterface
{
     ...
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_CODE = 'payment_review';

    /**
     * Custom Processing Order-Status label
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_LABEL = 'Payment Review';
